...
- (void)photosViewController:(NYTPhotosViewController *)photosViewController actionDownload:(NSString * _Nullable)url;

- (BOOL)photosViewController:(NYTPhotosViewController *)photosViewController captionViewHide:(id <NYTPhoto>)photo;
